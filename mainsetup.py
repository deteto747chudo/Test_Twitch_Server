...
twitch_miner = TwitchChannelPointsMiner(
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1271269920260493413/Dg3G82rFFIszLuHwn_knlicAx6KIFYgQWQRNbaJ3jlyrT7le3fHfI-5yEVHMJPVLTKFu",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION],                                  # Only these events will be sent to the chat
        ),
        matrix=Matrix(
...
# You can customize the settings for each streamer. If no settings were provided, the script would use the streamer_settings from TwitchChannelPointsMiner.
