...
# Define the Discord webhook URL globally
WEBHOOK_URL = 'https://discord.com/api/webhooks/1273853718072131690/ht2qqAfPbSFTSgnBSxuCZtdyaoP1qMPZX2i7R_jx5FxJ-H9GquDD4WHUvEZyss-eSGA5'
...
class Streamer(object):
    ...
    def discordmessage(self):
        streamer_info = f"**Server 0 : {_millify(self.channel_points)}\n----------------------------------------**"
        print(f"Sending message to Discord: {streamer_info}")
        send_to_discord(streamer_info)
